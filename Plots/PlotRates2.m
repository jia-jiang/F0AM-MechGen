function SpRates = PlotRates2(Spname,S,n2plot,varargin)
...
% Ensure all values in are finite
P2plot(~isfinite(P2plot)) = 0; % Replace non-finite values with 0
L2plot(~isfinite(L2plot)) = 0; % Replace non-finite values with 0
...
saveas(new_figure, strcat(save_path,'/',Spname,' Rates.png'))
