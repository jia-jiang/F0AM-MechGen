function [X2plot,Xnames] = PlotConcGroup2(Sp2plot,S,n2plot,varargin)
...
varInfo = {...
    ...
    'name'        '[X]'       [];...
    'sortem'      1           [0 1];...
    'save_path'   'D:\F0AM\F0AM-4.3.0.1\Runs\Figure\'    [];...
    };
...
legend(Xnames,'Location','eastoutside')
ylabel([name ' (' unitS ')'])
xlabel('Model Time')
xlim([min(Time) max(Time)])
purtyPlot
%save .png file to specified file path
saveas(new_figure, strcat(save_path,'/',name,' Conc Group.png'))
