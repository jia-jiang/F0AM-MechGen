...
% 103, <R087>, New
i=i+1;
Rnames{i} = 'A_API + HO = 0.97500*A_APIP1 +  0.02500*A_APIP2 ';
...
% 161, <R146>, New
i=i+1;
Rnames{i} = 'A_API + NO3 = 0.97500*A_APINP1 + 0.02500*A_APINP2';
...
% 353, <TRP53>, New
i=i+1;
Rnames{i} = 'A_APINP1 + NO3 = 2*NO2 + PINAL';
k(:,i) = (  2.3000E-12 ); 
...
% 314, <TRP36>, New
i=i+1;
Rnames{i} = 'A_APINP1 + ACO3 = NO2 + PINAL + MO2';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
...
% 244, <TRP27>
i=i+1;
Rnames{i} = 'A_PINALP + HO2 = 0.75000*OPB +  0.25000*HO +  0.25000*HOM ';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
...
% 147, <R131>, New
i=i+1;
Rnames{i} = 'A_API + O3 = 0.77*HO + 0.33*A_PINALP + 0.22*H2O2 + 0.39*A_PINAL + 0.01*ORA2 + 0.17*HO2 + 0.17*CO + 0.27*HCHO + 0.27*RCO3';
