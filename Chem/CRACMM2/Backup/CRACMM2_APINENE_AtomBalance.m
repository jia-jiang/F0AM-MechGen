...
% 103, <R087>, New
i=i+1;
Rnames{i} = 'API + HO  =  0.97500*APIP1 +  0.02500*APIP2  + -2.0000*DELTA_O';
k(:,i) = (  1.2100E-11.*exp(  4.4000E+02./T) ); 
Gstr{i,   1}='A_API';Gstr{i,   2}='HO';
fA_API(i)=fA_API(i)-1.0;fHO(i)=fHO(i)-1.0;
fA_APIP1(i)=fA_APIP1(i)+0.9750;fA_APIP2(i)=fA_APIP2(i)+0.0250;

% 194, <R189>, New, Need more NO2, but not increase HO2
i=i+1;
Rnames{i} = 'APIP1 + NO  =  0.23*TRPN + 0.77*HO2 + 0.77*NO2 + 0.3*PINAL + 0.27*ALD + 0.09*ACT + 0.09*LIMAL + 0.21*HCHO + 0.11*OPB + 1.4100*DELTA_C + -1.6800*DELTA_O'; 
...
% 351, <R339>, New
i=i+1;
Rnames{i} = 'APIP1 + NO3  =  NO2 + HO2 + 0.39*PINAL + 0.35*ALD + 0.12*ACT + 0.12*LIMAL + 0.27*HCHO + 0.14*OPB + 1.8200*DELTA_C + -0.1800*DELTA_O';
k(:,i) = (  2.3000E-12 ); 
...
i=i+1;
Rnames{i} = 'APIP1 + HO2  =  0.06*ACT + 0.06*LIMAL + 0.08*HCHO + 0.65*OPB + 0.48*HO2 + 0.29*PINAL + 0.35*HO + -0.2600*DELTA_C + 0.9000*DELTA_O'; 
...
% 275, <R265>, New
i=i+1;
Rnames{i} = 'APIP1 + MO2  =  0.83*HCHO + 0.14*LIMAL + 0.42*PINAL + 0.2*ALD + 0.13*OPB + 0.17*MOH + 0.11*KET + 0.06*ACT + 1.16*HO2 + 1.7700*DELTA_C + -0.2000*DELTA_O';
k(:,i) = (  2.0000E-12 ); 
...
% 312, <R301>, New
i=i+1;
Rnames{i} = 'APIP1 + ACO3  =  0.39*PINAL + 0.35*ALD + 0.14*OPB + 0.12*ACT + 0.12*LIMAL + 0.27*HCHO + HO2 + MO2 + 2.8200*DELTA_C + -0.1800*DELTA_O';
...
% 195, <TRP13>
i=i+1;
Rnames{i} = 'APIP2 + NO  =  0.82000*HO +  0.82000*NO2 + HOM  + 0.1800*DELTA_N + -5.4600*DELTA_O';
k(:,i) = (  4.0000E-12 ); 
...
% 237, <TRP21>
i=i+1;
Rnames{i} = 'APIP2 + HO2  =  HOM  + -2.0000*DELTA_O';
k(:,i) = (  1.5000E-11 ); 
...
% 276, <TRP29>
i=i+1;
Rnames{i} = 'APIP2 + MO2  =  HO2 +  0.75000*HCHO +  0.25000*MOH + HOM  + -5.0000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 313, <TRP35>
i=i+1;
Rnames{i} = 'APIP2 + ACO3  =  0.50000*HO +  0.50000*MO2 +  0.50000*ORA2 + HOM  + 0.5000*DELTA_C + -3.5000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 161, <R146>, New
i=i+1;
Rnames{i} = 'API + NO3  =  0.97500*APINP1 + 0.02500*APINP2 + -2.0000*DELTA_O';
k(:,i) = (  1.1900E-12.*exp(  4.9000E+02./T) ); 
Gstr{i,   1}='A_API';Gstr{i,   2}='NO3';
fA_API(i)=fA_API(i)-1.0;fNO3(i)=fNO3(i)-1.0;
fA_APINP1(i)=fA_APINP1(i)+0.9750;fA_APINP2(i)=fA_APINP2(i)+0.0250;

% 196, <TRP14>, New
i=i+1;
Rnames{i} = 'APINP1 + NO  =  1.86*NO2 + 0.07*TRPN + 0.07*ONIT + 0.93*PINAL + -0.2800*DELTA_C + -0.0700*DELTA_O';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 353, <TRP53>, New
i=i+1;
Rnames{i} = 'APINP1 + NO3  =  2*NO2 + PINAL + 2.0000*DELTA_O';
k(:,i) = (  2.3000E-12 ); 
...
% 238, <TRP22>, New
i=i+1;
Rnames{i} = 'APINP1 + HO2  =  0.3*TRPN + 0.7*PINAL + 0.7*NO2 + 0.7*HO + 2.3000*DELTA_O';
...
% 277, <TRP30>, New
i=i+1;
Rnames{i} = 'APINP1 + MO2  =  0.18*TRPN + 0.95*HCHO + 0.05*MOH + 0.82*HO2 + 0.82*NO2 + 0.82*PINAL + 0.3600*DELTA_O';
k(:,i) = (  2.0000E-12 ); 
...
% 314, <TRP36>, New
i=i+1;
Rnames{i} = 'APINP1 + ACO3  =  NO2 + PINAL + MO2 + 1.0000*DELTA_C + 2.0000*DELTA_O';
k(:,i) = (  2.0000E-12.*exp(  5.0000E+02./T) ); 
...
% 197, <TRP15>
i=i+1;
Rnames{i} = 'APINP2 + NO  =  0.82000*NO2 +  0.82000*HO + HOM  + 1.1800*DELTA_N + -3.4600*DELTA_O';
k(:,i) = (  4.0000E-12 ); 
...
% 244, <TRP27>
i=i+1;
Rnames{i} = 'PINALP + HO2  =  0.75000*OPB +  0.25000*HO +  0.25000*HOM  + 1.7500*DELTA_O';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
...
% 278, <TRP31>
i=i+1;
Rnames{i} = 'APINP2 + MO2  =  0.75000*HO2 +  0.75000*NO2 +  0.25000*MOH +  0.75000*HCHO + HOM  + 0.2500*DELTA_N + -4.0000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 378, <TRP41>
i=i+1;
Rnames{i} = 'APIP2 + APIP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 3.3600*DELTA_C + -3.9200*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 384, <TRP47>
i=i+1;
Rnames{i} = 'APINP2 + APIP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 3.3600*DELTA_C + -2.4000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 379, <TRP42>
i=i+1;
Rnames{i} = 'APIP2 + LIMP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 3.3600*DELTA_C + -3.9200*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 380, <TRP43>
i=i+1;
Rnames{i} = 'APIP2 + ISOP  =  0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 0.7600*DELTA_C + -3.9200*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 381, <TRP44>
i=i+1;
Rnames{i} = 'LIMP2 + APIP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 3.3600*DELTA_C + -3.9200*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 385, <TRP48>
i=i+1;
Rnames{i} = 'APINP2 + LIMP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*LIMAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 3.3600*DELTA_C + -2.4000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 386, <TRP49>
i=i+1;
Rnames{i} = 'APINP2 + ISOP  =  0.96000*HOM +  0.48000*ROH +  0.48000*HCHO +  0.48000*MVK +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 0.7600*DELTA_C + -2.4000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 387, <TRP50>
i=i+1;
Rnames{i} = 'LIMNP2 + APIP1  =  0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 3.3600*DELTA_C + -2.4000*DELTA_O';
k(:,i) = (  1.0000E-10 ); 
...
% 147, <R131>, New
i=i+1;
Rnames{i} = 'API + O3  =  0.77*HO + 0.33*PINALP + 0.22*H2O2 + 0.39*PINAL + 0.01*ORA2 + 0.17*HO2 + 0.17*CO + 0.27*HCHO + 0.27*RCO3 + 1.5300*DELTA_C + -1.9200*DELTA_O';
k(:,i) = (  8.0500E-16.*exp( -6.4000E+02./T) ); 
Gstr{i,   1}='A_API';Gstr{i,   2}='O3';
fA_API(i)=fA_API(i)-1.0;fO3(i)=fO3(i)-1.0;
fHO(i)=fHO(i)+0.77;fA_PINALP(i)=fA_PINALP(i)+0.33;fH2O2(i)=fH2O2(i)+0.22;fA_PINAL(i)=fA_PINAL(i)+0.39;fORA2(i)=fORA2(i)+0.01;fHO2(i)=fHO2(i)+0.17;fCO(i)=fCO(i)+0.17;fHCHO(i)=fHCHO(i)+0.27;fRCO3(i)=fRCO3(i)+0.27;
fKET(i)=fKET(i);fHC3(i)=fHC3(i);fOP1(i)=fOP1(i);fORA1(i)=fORA1(i);fDELTA_C(i)=fDELTA_C(i);

%--------------------------------------------------------------------------
% 105, <TRP04>, New
i=i+1;
Rnames{i} = 'PINAL + HO  =  0.23000*PINALP +  0.77000*RCO3  + 5.3900*DELTA_C + -0.2300*DELTA_O';
...
% 202, <TRP19>, New
i=i+1;
Rnames{i} = 'PINALP + NO  =  0.36*TRPN + 0.64*HOM + 0.64*NO2 + -2.2000*DELTA_O';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 244, <TRP27>, New
i=i+1;
Rnames{i} = 'PINALP + HO2  =  0.75*OPB + 0.25*HO + 0.25*HOM + 1.7500*DELTA_O';
k(:,i) = (  2.7100E-13.*exp(  1.3000E+03./T) ); 
Gstr{i,   1}='A_PINALP';Gstr{i,   2}='HO2';
fA_PINALP(i)=fA_PINALP(i)-1.0;fHO2(i)=fHO2(i)-1.0;
...
% 175, <TRP11>, New
i=i+1;
Rnames{i} = 'PINALP  =  HOM  + -3.0000*DELTA_O';
k(:,i) = (  2.9000E-02 ); 
Gstr{i,   1}='A_PINALP';
...
% 142, <TRP07>, New
i=i+1;
Rnames{i} = 'TRPN + HO  =  0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET + 1.2730*DELTA_C + -0.0654*DELTA_O';
k(:,i) = (  4.8000E-12 ); 
...
% 163, <TRP10>, New
i=i+1;
Rnames{i} = 'TRPN + NO3  =  0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET + 1.2730*DELTA_C + 1.0000*DELTA_N + 1.9346*DELTA_O';
...
% 150, <TRP09>, New
i=i+1;
Rnames{i} = 'TRPN + O3  =  0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET + 1.2730*DELTA_C + 1.9346*DELTA_O';
k(:,i) = (  1.6700E-16 ); 
