...
% 378, <TRP41>
i=i+1;
Rnames{i} = 'APIP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 3.3600*DELTA_C';
k(:,i) = (  1.0000E-10 ); 
...
% 384, <TRP47>
i=i+1;
Rnames{i} = 'APINP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 3.3600*DELTA_C';
k(:,i) = (  1.0000E-10 ); 
...
% 381, <TRP44>
i=i+1;
Rnames{i} = 'LIMP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*HO +  0.48000*HO2 +  0.04000*ELHOM  + 3.3600*DELTA_C';
k(:,i) = (  1.0000E-10 ); 
...
% 387, <TRP50>
i=i+1;
Rnames{i} = 'LIMNP2 + APIP1 = 0.96000*HOM +  0.48000*ROH +  0.48000*PINAL +  0.48000*NO2 +  0.48000*HO2 +  0.04000*ELHOM  + 0.5200*DELTA_N + 3.3600*DELTA_C';
k(:,i) = (  1.0000E-10 ); 
...
% 142, <TRP07>, New
i=i+1;
Rnames{i} = 'TRPN + HO = 0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET';
k(:,i) = (  4.8000E-12 ); 
...
% 163, <TRP10>, New
i=i+1;
Rnames{i} = 'TRPN + NO3 = 0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET';
...
% 150, <TRP09>, New
i=i+1;
Rnames{i} = 'TRPN + O3 = 0.33*HONIT + 0.67*NO2 + 0.4154*PINAL + 0.2546*KET';
k(:,i) = (  1.6700E-16 ); 
