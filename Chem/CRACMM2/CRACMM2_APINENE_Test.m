...
% % 202, <TRP19>, Modified by Jia
% i=i+1;
% Rnames{i} = 'A_PINALP + NO = 0.36*A_TRPN + 0.64*HOM + 0.64*NO2';
% k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
% Gstr{i,   1}='A_PINALP';Gstr{i,   2}='NO';
% fA_PINALP(i)=fA_PINALP(i)-1.0;fNO(i)=fNO(i)-1.0;
% fA_TRPN(i)=fA_TRPN(i)+0.36;
% fNO2(i)=fNO2(i)+0.64;
% fHOM(i)=fHOM(i)+0.64; 
...
% % Added by Jia
% i=i+1;
% Rnames{i} = 'A_APIP1 + NO2 = ACO3 + NO2'; 
% k(:,i) = ( 0 ); 
% Gstr{i,   1}='A_APIP1';Gstr{i,   2}='NO2';
% fA_APIP1(i)=fA_APIP1(i)-1.0;
% fACO3(i)=fACO3(i)+1.0;
% 
% Added by Jia
i=i+1;
Rnames{i} = 'A_PINALP + NO2 = PAN'; 
...
k(:,i) = (KC0.*KCI).*FC./(KC0+KCI) ;
Gstr{i, 1}='A_PINALP'; Gstr{i, 2}='NO2';
fA_PINALP(i)=fA_APIP1(i)-1.0;
fNO2(i)=fNO2(i)-1.0;
fPAN(i)=fPAN(i)+1.0;
